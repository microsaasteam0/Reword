...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Reword - AI Repurposing for X, LinkedIn & Instagram',
    template: '%s | Reword'
  },
  description: 'Reword: The ultimate AI tool to repurpose blogs & newsletters into optimized posts for X (Twitter), LinkedIn, and Instagram in seconds.',
  ...
  openGraph: {
    ...
    url: '/',
    siteName: 'Reword',
    title: 'Reword - AI Repurposing for X, LinkedIn & Instagram',
    description: 'Reword: The ultimate AI tool to repurpose blogs & newsletters into optimized posts for X (Twitter), LinkedIn, and Instagram in seconds.',
    images: [
      {
        url: '/og-image.png',
