...
💡 Pro tip: The more detailed your content, the better we can optimize it for each platform!"
          ...
          {results && (
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="grid gap-8 lg:grid-cols-1 xl:grid-cols-1">
                {/* X Thread */}
                {results.twitter_thread && results.twitter_thread.length > 0 && (
                ...
                {/* Instagram Carousel */}
                {results.instagram_carousel && results.instagram_carousel.length > 0 && (
      ...
      <div className="relative overflow-hidden bg-white dark:bg-slate-900 shadow-2xl rounded-[2.5rem] p-10 text-center border border-slate-200 dark:border-slate-800 group hover:shadow-blue-500/10 transition-all duration-500">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="flex flex-col items-center justify-center mb-8">
            <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-3xl flex items-center justify-center shadow-2xl shadow-purple-500/30 mb-6 transform group-hover:rotate-6 transition-transform duration-500">
          ...
          <form onSubmit={handleNewsletterSubscribe} className="max-w-xl mx-auto mb-12">
            <div className="flex flex-col sm:flex-row bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-3xl p-2 shadow-inner focus-within:ring-4 focus-within:ring-blue-500/10 transition-all duration-300 gap-2">
              <div className="flex items-center flex-1 px-4">
                <span className="text-slate-400 font-black text-xl mr-3">@</span>
                <input
                  type="email"
                  placeholder="Enter your email address"
                  value={newsletterEmail}
                  onChange={(e) => setNewsletterEmail(e.target.value)}
                  className="flex-1 bg-transparent text-slate-900 dark:text-white placeholder-slate-400 py-4 focus:outline-none text-base font-bold min-w-0"
              ...
              <button
                ...
                className="px-10 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 disabled:from-slate-400 disabled:to-slate-500 text-white rounded-2xl font-black transition-all duration-300 flex items-center justify-center shadow-xl shadow-blue-500/20 active:scale-95 group/btn"
              >
                {isSubscribing ? '...' : (
                  <>
                    Join the Club
            ...
            <p className="text-sm font-bold text-slate-400 mt-4 flex items-center justify-center gap-2">
              <Sparkles className="w-4 h-4 text-pink-500" />
              No spam, just pure strategy. Unsubscribe anytime.
            </p>
          </form>

          <div className="mb-12">
            <p className="text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest text-xs mb-6">Follow for daily tips</p>
            <div className="flex justify-center flex-wrap gap-4">
              {[
                { name: 'Discord', href: 'https://discord.com/invite/ZZx3cBrx2', icon: <MessageSquare className="w-6 h-6" />, color: 'hover:bg-indigo-500' },
                { name: 'Entrext', href: 'https://linktr.ee/entrext.in', icon: <Globe className="w-6 h-6" />, color: 'hover:bg-emerald-500' },
                { name: 'LinkedIn', href: 'https://www.linkedin.com/company/entrext/posts/?feedView=all', icon: <Linkedin className="w-6 h-6" />, color: 'hover:bg-blue-600' },
                { name: 'Instagram', href: 'https://www.instagram.com/entrext.labs/', icon: <Instagram className="w-6 h-6" />, color: 'hover:bg-pink-600' },
                { name: 'Substack', href: 'https://substack.com/@entrextlabs', icon: <Mail className="w-6 h-6" />, color: 'hover:bg-orange-500' }
              ].map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  ...
                  className={`w-14 h-14 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl flex items-center justify-center transition-all duration-300 hover:text-white shadow-sm hover:shadow-xl transform hover:-translate-y-1 ${social.color}`}
                  title={social.name}
                >
                  {social.icon}
                </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-8 border-t border-slate-200 dark:border-slate-800">
            <div className="text-center group/stat">
              <div className="text-3xl font-black text-blue-600 dark:text-blue-400 mb-1 group-hover/stat:scale-110 transition-transform">5K+</div>
              <div className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Global Creators</div>
            </div>
            <div className="text-center group/stat">
              <div className="text-3xl font-black text-purple-600 dark:text-purple-400 mb-1 group-hover/stat:scale-110 transition-transform">50K+</div>
              <div className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Posts Generated</div>
            </div>
            <div className="text-center group/stat">
              <div className="text-3xl font-black text-emerald-500 dark:text-emerald-400 mb-1 group-hover/stat:scale-110 transition-transform">99.9%</div>
              <div className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest">Service Uptime</div>
            </div>
          </div>
        </div>
      </div>
